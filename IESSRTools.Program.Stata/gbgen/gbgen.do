...
capture drop gb99trans
capture drop isco88trans
capture drop gb99isei

capture program drop gb99_to_isco08
...
capture program drop isco08_to_gb99
...
capture program drop gb99_to_isei
...
capture program drop label_gb99
...
gb99_to_isco08 gb99, gen(gb99trans)
isco08_to_gb99 isco88, gen(isco88trans)
gb99_to_isei gb99, gen(gb99isei)

//label_gb99 gb99, label(gb99)
//label_gb99 isco88trans, label(isco88trans)
